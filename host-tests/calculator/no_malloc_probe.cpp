...
int main() {
  ...
  static const char* kWorkout[] = {
      "1/3=",       "2/7=",         "1/9999999999=", "9999999999/3=", "0.0000000001/7=",
      "1/3x3=",     "22/7x7/22=",   "9999999999x9999999999=", "1/7+1/7+1/7=",
      "123456789/987654321=", "0.1+0.2-0.3=", "50+10%=", "500x5%=", "1/0=",
  };
  ...
  std::printf("%s: %d checks, %d failed  (%d malloc calls from decNumber)\n",
              calc_probe_calls ? "FAILED" : "ok", 1, calc_probe_calls ? 1 : 0, calc_probe_calls);
